...
<head>
	...
	<title>Tathastu's LIC & Star Health Recruitment Point</title>
	<style type="text/css">
		body{
    ...
    if(isset($_POST['submit']))
     {
		 ...
		 include "connection.php" ;
			{
				$sql = "insert into lifeagents VALUES('".$fname."','".$mname."','".$lname."','$dob','".$address."','$phone','".$email."','".$quali."','$pan','$adhar')";
        ...
        <center >
            <div id="container">
				...
				Agent Recruitment
					...
					<input type="hidden" id="cate" name="cate" value="Life Insurance">
